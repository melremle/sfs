...
<body class="g-sidenav-show bg-gray-200" style="height: calc(100% - 58px);">
    ...
    <main style="margin-top: 58px">
        <div class="container-fluid">
            <div class="row">
                <div class="card-header">
                    <div class="pb-2 pt-2">
                        <h4 class="text-dark">All Files</h4>
                        <small class="text-muted">You can view details and download the files uploaded by your users here</small>
                        <br>
                        <em><small class="text-info">Left click an item to view details or right click an item to download</small></em>
                    </div>
                </div>
                <div class="col-12">
                        ...
                        <div class="card-body px-2 pb-2">
                            <div class="table-responsive pb-4 px-4">
                                <table id="tbl-drive" data-id="<?= $_SESSION['user']['id'] ?>" class="table align-items-center mb-0 table-hover">
                                    <thead>
                                        <tr>
                                            <th style="max-width: 100px" class="opacity-7">Owner</th>
        ...
        require_once dirname(__DIR__, 2) . '/templates/modals/share-modal.php';
        require_once dirname(__DIR__, 2) . '/templates/modals/rename-modal.php';
