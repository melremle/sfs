...
<body class="g-sidenav-show bg-gray-200" style="height: calc(100% - 58px);">
    ...
    <main style="margin-top: 58px">
            ...
            <div class="row">
                <div class="card-header">
                    <div class="pb-2 pt-2">
                        ...
                        <small class="text-muted">You can manage offices here</small>
                        <br>
                ...
                <div class="col-12">
                    <div class="card my-3" style="max-height: 100vh;">
                        <div class="card-body px-2 pb-2">
                            <button id="btn-add-office" class="btn btn-primary mb-4 ms-4" style="width: 160px;"><i class="fa fa-add me-2"></i> Add Office</button>
                            <div class="table-responsive pb-4 px-4">
                                <table id="tbl-offices" class="table align-items-center mb-0 table-hover">
                                    <thead>
                                        <tr>
                                            <th class="opacity-7">Office</th>
                                            <th class="opacity-7" style="max-width: 400px;">Logo</th>
            ...
            <div class="modal-dialog modal-sm">
                <div class="modal-content">
                    <div class="modal-body">
                        Are you sure you want to delete "<span id="span-office"></span>"?
                    </div>
        ...
        <?php
        require_once dirname(__DIR__, 2) . '/templates/modals/admin/office-modal.php';
